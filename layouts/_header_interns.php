<header class="header-internas">
	<div class="container container-custom">
		<div class="row d-flex align-items-center">
			...
			<div class="col-lg-8 text-right">
				<nav class="menu">
					<ul>
						...
						<li>
							<a href="javascript:;" class="open-submenu <?=($pagina == 'servicos'? 'active' : '')?>">Serviços</a>
							<ul  class="sub-menu">
								...
								<li><a href="detetive-particular.php">Detetive Particular</a></li>
								<li><a href="eventos-staff.php">Staff Eventos</a></li>
								<li><a href="eventos-staff.php#festa">Segurança para Eventos</a></li>
			...
			<div class="col-lg-1">
				<aside class="social-media-header">
					<ul>
