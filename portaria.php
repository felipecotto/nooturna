...
<html>
	<head>
        ...
        <!-- Title -->
		<title> Portarias e | Grupo Nooturna </title>
		<!-- Stylesheets -->
	...
	<body class="servicos">
		...
		<section class="banner-servicos capa-portaria">
			
		</section>		
		<div class="container mb-100">
			<div class="row foo">
				<div class="col-lg-6">
					<img src="assets/dist/images/icon-portaria.png" alt="Segurança Patrimonial" class="img-fluid m-0-auto d-block mb-30">
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6 foo">
					<h1 class="text-uppercase text-center">Portaria</h1>
				...
				<div class="col-lg-6 foo">
					<img src="assets/dist/images/portaria.jpg" alt="" class="img-fluid">
				</div>
			</div>
		</div>
